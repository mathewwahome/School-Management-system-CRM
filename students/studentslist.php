...
if (isset($_POST['insert_btn'])){
    ...
    $adm = $_POST['adm'];
    $form= $_POST['form'];
    include_once "../database/connection_db.php";
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="collapsibleNavbar">
                    <ul class="navbar-nav navnavfloat">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../teacher/teacherspage.php">Teachers page</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="col-6">
            ...
            <div>
                ...
                <form action="studentslist.php" method="post" class="form">
                    ...
                    <input type="text" value="<?php echo $userName; ?>" name="name" required placeholder="Name" class="form-control">
                    <input type="text" value="<?php echo $adm; ?>" name="adm" required placeholder="Admission" class="form-control">
                    <input type="number"  name="form" placeholder="Form" required class="form-control">
